...
{
    /// <summary>
    /// Registers controllers with the JSON conventions every service shares: camelCase names,
    /// nulls omitted, enums as their names ("sofas", "modenza") instead of bare integers.
    /// </summary>
    /// <param name="services">Service collection</param>
    /// <returns>MVC builder to add validators or filters to</returns>
