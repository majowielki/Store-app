 ...
 * variable (local development), then the same-origin "/api" that nginx proxies to the gateway.
 */
export const apiBaseUrl: string = runtime.apiBaseUrl || import.meta.env.VITE_API_BASE_URL || '/api';
